...
## Project Structure
    ...
    ├── loveworks_in_virgin_34895  # Django project configurations
...
1. Clone this repo and `cd loveworks_in_virgin_34895`
...
2. Clone this repo and `cd loveworks_in_virgin_34895`
